...
| File | Rows | Years |
|---|---:|---|
| `budget-history.csv` | 528 | 2002–2027 |
...
|---|---:|---|---|
| One row per (year, measure, basis) | 528 | exact | none |
...
| General Fund half + dedicated half = `budget_operating` | 13 | $0.2M | $0.001M (2012 adopted) |
| `budget_operating` + `budget_capital` = `budget_total` | 19 | $0.2M | $0.100M (2025 adopted) |
| Sales and use tax components sum to `salesuse_total` | 8 | $0.05M | $0.040M (2026 forecast) |
| Revenue components sum to that year's `revenue_total` | 7 | $0.02M | $0.001M (2026 recommended) |
...
| `books` | 162 | 2003–2023, 2025–2026 |
| `deptsnapshot2026` | 24 | 2024–2026 |
| `booksocr` | 132 | 2002, 2005–2013, 2017–2019, 2024 |
| `brl2027` | 1 | 2027 |
...
|---|---|---|---|
| `budget_capital` | musd | 2005–2017, 2022–2027 | `adopted`, `recommended` |
| `budget_general_fund` | musd | 2005–2012, 2014–2018, 2024–2027 | `actual`, `adopted`, `derived`, `projected`, `recommended` |
| `budget_general_fund_revenue` | musd | 2003–2013 | `actual`, `adopted`, `projected` |
| `budget_operating` | musd | 2005–2027 | `adopted`, `recommended` |
| `budget_operating_dedicated` | musd | 2005–2017 | `adopted` |
| `budget_operating_general` | musd | 2005–2017 | `adopted` |
...
| `revenue_intergovernmental` | musd | 2007–2012, 2026 | `adopted`, `recommended` |
...
| `revenue_other_unmapped` | musd | 2007–2012 | `adopted` |
| `revenue_parking` | musd | 2026 | `recommended` |
| `revenue_property_tax` | musd | 2007–2012, 2026 | `adopted`, `recommended` |
| `revenue_sales_use_tax` | musd | 2007–2012, 2026 | `adopted`, `recommended` |
| `revenue_total` | musd | 2007–2012, 2026 | `adopted`, `recommended` |
| `revenue_utility` | musd | 2007–2012, 2026 | `adopted`, `recommended` |
...
| `staffing_fte` | fte | 2002–2013, 2016–2018, 2021–2026 | `adopted`, `restated` |
