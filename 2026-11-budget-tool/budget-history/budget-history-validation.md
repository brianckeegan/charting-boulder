...
| File | Rows | Years |
|---|---:|---|
| `budget-history.csv` | 450 | 2002–2027 |
| `budget-history-wide.csv` | 26 | 2002–2027 |
| `budget-history-department-crosswalk.csv` | 241 | 2005–2006, 2011–2022, 2024–2026 |
...
|---|---:|---|---|
| One row per (year, measure, basis) | 450 | exact | none |
| Department buckets, plus any balancing line, sum to `budget_total` | 17 | $0.05M | $0.002M (2026 deptexpfiltered_*) |
| A department label keeps its bucket from year to year, or a note says why | 70 | exact | none |
| General Fund half + dedicated half = `budget_operating` | 10 | $0.2M | $0.001M (2012 adopted) |
| `budget_operating` + `budget_capital` = `budget_total` | 16 | $0.2M | $0.100M (2025 adopted) |
| Sales and use tax components sum to `salesuse_total` | 8 | $0.05M | $0.040M (2026 forecast) |
| Revenue components sum to that year's `revenue_total` | 3 | $0.02M | $0.001M (2026 recommended) |
...
|---|---:|---|
| `rec2026` | 13 | 2026 |
| `forecast2026` | 100 | 2022–2027 |
| `rec2027` | 9 | 2027 |
| `glance2027` | 6 | 2027 |
| `snapshot2023` | 81 | 2021–2023 |
| `books` | 164 | 2003–2023, 2025–2026 |
| `deptsnapshot2026` | 24 | 2024–2026 |
| `booksocr` | 52 | 2002, 2011–2013, 2017–2019 |
| `brl2027` | 1 | 2027 |
...
| `basis` | Rows | Years |
|---|---:|---|
| `actual` | 72 | 2003–2004, 2006, 2009, 2021–2025 |
| `adopted` | 290 | 2002–2026 |
| `derived` | 6 | 2010, 2024–2026 |
| `forecast` | 9 | 2026–2027 |
| `identified` | 3 | 2025–2026 |
| `policy` | 1 | 2026 |
| `projected` | 2 | 2007, 2009 |
| `recommended` | 28 | 2026–2027 |
| `restated` | 2 | 2011–2012 |
...
|---|---|---|---|
| `budget_capital` | musd | 2005–2006, 2008, 2011–2017, 2022–2027 | `adopted`, `recommended` |
| `budget_general_fund` | musd | 2006–2012, 2014–2018, 2024–2027 | `actual`, `adopted`, `derived`, `projected`, `recommended` |
| `budget_general_fund_revenue` | musd | 2003–2007, 2009–2013 | `actual`, `adopted`, `projected` |
| `budget_operating` | musd | 2005–2006, 2008, 2011–2027 | `adopted`, `recommended` |
| `budget_operating_dedicated` | musd | 2005–2006, 2008, 2011–2017 | `adopted` |
| `budget_operating_general` | musd | 2005–2006, 2008, 2011–2017 | `adopted` |
| `budget_total` | musd | 2004–2006, 2008, 2010–2027 | `adopted`, `derived`, `recommended` |
| `deptexp_administration` | musd | 2005–2006, 2011–2022 | `adopted` |
| `deptexp_citywide_debt` | musd | 2005–2006, 2011–2018 | `adopted` |
| `deptexp_community_services` | musd | 2005–2006, 2011–2022 | `adopted` |
| `deptexp_infrastructure` | musd | 2005–2006, 2011–2022 | `adopted` |
| `deptexp_parks_openspace` | musd | 2005–2006, 2011–2022 | `adopted` |
| `deptexp_planning_climate` | musd | 2005–2006, 2011–2022 | `adopted` |
| `deptexp_public_safety` | musd | 2005–2006, 2011–2022 | `adopted` |
...
| `revenue_intergovernmental` | musd | 2011–2012, 2026 | `adopted`, `recommended` |
...
| `revenue_other_unmapped` | musd | 2011–2012 | `adopted` |
| `revenue_parking` | musd | 2026 | `recommended` |
| `revenue_property_tax` | musd | 2011–2012, 2026 | `adopted`, `recommended` |
| `revenue_sales_use_tax` | musd | 2011–2012, 2026 | `adopted`, `recommended` |
| `revenue_total` | musd | 2010–2012, 2026 | `adopted`, `derived`, `recommended` |
| `revenue_utility` | musd | 2011–2012, 2026 | `adopted`, `recommended` |
...
| `staffing_fte` | fte | 2002–2013, 2016–2018, 2021–2023, 2025–2026 | `adopted`, `restated` |
...
|---|---|---:|---:|---:|
| `deptexp` | 2005–2006, 2011–2022 | 181 | 71 | 71 |
...
|---|---|---|
| `public_safety` | 2005–2006, 2011–2022 | 2024–2026 |
| `infrastructure` | 2005–2006, 2011–2022 | 2024–2026 |
| `parks_openspace` | 2005–2006, 2011–2022 | 2024–2026 |
| `community_services` | 2005–2006, 2011–2022 | 2024–2026 |
| `planning_climate` | 2005–2006, 2011–2022 | 2024–2026 |
| `administration` | 2005–2006, 2011–2022 | 2024–2026 |
| `citywide_debt` | 2005–2006, 2011–2018 | 2024–2026 |
