    ...
    <div ref={rootRef} style={{ background: C.paper, color: C.ink, fontFamily: FONT }} className="w-full">
      ...
      <div className="bbw mx-auto" style={{ maxWidth: 680, padding: "8px 16px 56px" }}>
        ...
        <section className="mt-6">
          ...
          <p style={{ fontSize: 13.5, color: C.inkSoft, marginTop: 8 }}>Of Boulder’s {fmt(TOTAL)} budget ({fmt(OPERATING)} operating, {fmt(CAPITAL)} one-time capital), the shortfall lives in the General Fund — <strong style={{ color: C.ink }}>{fmt(GENERAL_FUND)}, about {pctMovable.toFixed(0)}¢ of every dollar</strong> — the only large pot the council can freely redirect. The rest is dedicated by voters, restricted by law, or tied up in capital projects.</p>
        ...
        <section className="mt-6">
          ...
          <p style={{ fontSize: 12.5, color: C.inkSoft, marginTop: 6 }}>Each gap is the city’s estimate of what continuing the previous year’s services would cost minus the revenue it expects — not an unbalanced budget, but the shortfall the council must close before adopting one. The council closed 2026’s <strong style={{ color: C.ink }}>$7.5M</strong> last fall; the <strong style={{ color: C.ink }}>$6.5M</strong> forecast for 2027 is yours. One-time reserves can patch 2026, but only cuts or recurring revenue fix the recurring 2027 gap. <em>How the city closed past gaps: Sources &amp; method, below.</em></p>
        </section>
        ...
        <section className="mt-7">
          ...
          <p style={{ fontSize: 12.5, color: C.inkSoft, marginTop: 10 }}><strong style={{ color: C.ink }}>Frozen, but not forever.</strong> On Aug. 6 the council settled what voters decide in November: a <strong style={{ color: C.ink }}>$400M recreation-and-safety bond</strong> for aging rec centers, fire stations and a police facility (about $400 a year on a $1M home), a charter change letting the city borrow against property’s actual rather than assessed value, collective bargaining for firefighters, and a <strong style={{ color: C.ink }}>$4,000-a-year tax on homes sitting empty</strong> more than half the year. Only the vacancy tax adds money the council can freely spend — roughly $4M a year, against the $6.5M gap you’re closing — and it starts in 2028, too late for the 2027 budget. The parks mill levy the council studied, which would have moved dedicated money into wider use, did not make the ballot.</p>
        </section>
        ...
        <section className="mt-8" style={{ borderTop: `3px solid ${C.ink}`, paddingTop: 18 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.55, color: C.inkSoft, marginTop: 10 }}>The budget totals, General Fund department figures, and legal limits are verified against the city’s 2026 adopted budget and Colorado law; the locked per-fund amounts are modeled pending fund-level data. The panel below says which is which.</p>
          <p style={{ fontSize: 13, lineHeight: 1.55, color: C.inkSoft, marginTop: 10 }}><strong style={{ color: C.ink }}>Where the gaps come from.</strong> Each year’s shortfall is the city’s projection of the cost of continuing the prior year’s adopted services (payroll, contracts, inflation) minus updated forecasts of ongoing revenue — sales tax flat since 2023, property tax constrained by recent state law. The $7.5M gap for 2026 was identified during 2025 budget development, against 2025 service levels; the $6.5M gap for 2027 comes from the May 2026 Financial Forecast, against 2026 service levels — the city’s phrase is “if left unaddressed.” Each year re-baselines on the services actually adopted the year before; Colorado law requires the adopted budget to balance, so every gap is closed — by cuts, revenue, or one-time money — before adoption.</p>
          <p style={{ fontSize: 13, lineHeight: 1.55, color: C.inkSoft, marginTop: 8 }}><strong style={{ color: C.ink }}>How past gaps were closed.</strong> Mid-2025’s $8–10M gap: a hiring freeze, 5% department savings, and one-time transfer reductions. 2026’s $7.5M: department reductions and realignments (19 mostly-vacant positions eliminated) plus about $6M in new citywide fees — $2.25M transportation maintenance, $2.6M speed-on-green cameras, $0.8M parking, $0.4M single-family expansion — while keeping the city’s emergency reserve, about 16.7% of operating, at target. Reserves are held for a downturn, not for ongoing costs.</p>
