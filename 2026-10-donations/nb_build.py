...
**Sides.** Each candidate carries a slate label from the group endorsements: `A` for the PLAN-Boulder
County slate, `B` for the Better Boulder / Boulder Progressives slate, `AB` for both, blank for
neither. A donor's side in a year is where most of their candidate dollars went (60/40 rule); `AB`
...
NARRATIVE = {
 ...
 "group slates": "## Group slates to side labels\n\n`parsed.csv` has one row per year, group, contest, choice and position, read from the captured pages. The side label uses the two poles of Boulder's decade-long divide: PLAN-Boulder County on one side, Better Boulder and Boulder Progressives on the other. The other groups are kept as slate columns but not used for the label, because their alignment moved: the Sierra Club endorsed PLAN's slate in 2015 and 2017 and Better Boulder's from 2019; Open Boulder sided with PLAN on three of four picks in 2025.",
