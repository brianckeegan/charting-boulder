...
## Notebooks
- `tipped_wages.ipynb` — five-figure analysis culminating in a Monte Carlo simulation (N=8,000) over tip income, hours per week, and rent growth to produce a fan chart of worker-income distributions under each policy scenario.
