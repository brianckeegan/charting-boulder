...
- Across ten age buckets, Boulder beats the peer median in six. The widest gap is not in a child bucket at all: at ages 35–44 Boulder was flat (−1.0%) while the median peer grew 14.5%, a gap of 15.5 points. Boulder added 25–34-year-olds and the over-65s faster than its peers, and did not add the cohort most likely to be raising school-age children. Children aged 0–9 in 2020 were 14.7% below what Boulder's own 2010 child ratios imply for its 2020 adults, more negative than 92% of peers.
