...
- Across all eighteen five-year age bands, Boulder beats the peer median in nine. The widest gap is not in a child band at all: at ages 35–39 Boulder was flat (−0.5%) while the median peer grew 19.3%, a gap of 20 points. Boulder added 25–34-year-olds and the over-65s faster than its peers, and did not add the cohort most likely to be raising school-age children. Children aged 0–9 in 2020 were 14.7% below what Boulder's own 2010 child ratios imply for its 2020 adults, more negative than 92% of peers.
